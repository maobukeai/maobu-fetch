...
export default function App() {
  ...
  const [columnWidths, setColumnWidths] = useState<Record<string, number>>({ size: 78, status: 82, connection: 64, progress: 130, speed: 78, eta: 82, created: 86 });
