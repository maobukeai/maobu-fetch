...
[![Version](https://img.shields.io/badge/version-0.6.8-blue.svg)](https://github.com/maobukeai/maobu-fetch/releases/tag/v0.6.8)
...
1. **下载插件包**：
   前往 GitHub Releases 页面下载最新版本的 [`extension.zip`](https://github.com/maobukeai/maobu-fetch/releases/tag/v0.6.8) 并解压到本地文件夹。
2. **开启浏览器开发者模式**：
